...
const Edit = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if(!coords.lat || !coords.lng){
     ...
     axios.post('/edit', JSON.stringify(formData)).then( (data) => {
  ...
  return (
    ...
    <form className='edit' onSubmit={handleSubmit}>
      <h5 className='edit__description-title'>Describe the Event</h5>
      <section className='edit__description'>
        <h5>Event Title</h5>
      ...
      <h5 className='edit__date-time-title'>Date and time</h5>
     
      <section className='edit__date-time'>
      ...
      <h5 className='edit__event-logistics-title'>Logistics</h5>
      <section className='edit__event-logistics'>
